...
<header>
	<div class="container">
		<nav class="ordinateur">
			...
			<ul>
				<li class="active"><a href="../php/accueil.php">Accueil</a></li>
				<li><a href="../php/offres.php">Nos Offres</a></li>
				<li><a href="../php/NosServices.php">Nos Services</a></li>
				<li><a href="../php/assistance.php">Contact</a></li>
